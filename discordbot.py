'''
    Mohammad Taqiuddin, Mohammad Azamuddin
...
# BOT VARIABLES
token="MTA0ODUzNjk0MzUwNTQ0NDkwNA.GCQH0p.b2nyhkJ0lnuLIAgvCpThAf7FVUg6kCqYv_OmAE"
...
async def image(context):
    try:
        ...
        if len(query) == 0:
            await context.send("you forgot to add a query")
            return
